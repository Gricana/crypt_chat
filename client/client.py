...
class message_monitor(QtCore.QThread):
    ...
    def __init__(self, server_socket, private_key):
...
class Client(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        if len(os.listdir('friend_id')) == 0:
            ...
            message = 'Put the interlocutor\'s ID in "friend_id"'
        ...
        if not os.path.exists('private'):
            ...
            self.ui.pushButton_2.setEnabled(False)
            self.ui.pushButton_4.setEnabled(False)
            message = 'You also need to generate your ID'
            self.ui.plainTextEdit.appendPlainText(message)
    ...
    def connect_server(self):
        ...
        try:
            ...
            self.ui.plainTextEdit.appendPlainText('Server connection error')
            self.ui.plainTextEdit.appendPlainText('Change the IDs and try again!')
    ...
    def generate_encrypt(self):
        if len(self.ui.lineEdit_4.text()) > 0 and len(self.ui.lineEdit_5.text()) > 0:
            ...
            self.ui.plainTextEdit_2.appendPlainText('Created "your_id" identifier')
            self.ui.plainTextEdit_2.appendPlainText('Pass it to the interlocutor and start a dialogue')
        else:
            self.ui.plainTextEdit_2.clear()
            self.ui.plainTextEdit_2.appendPlainText('Check the correctness of the data entered!')
