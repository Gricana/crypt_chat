...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Crypt Chat 1.0"))
        self.pushButton_4.setText(_translate("MainWindow", "Clear"))
        self.pushButton.setText(_translate("MainWindow", "Send"))
        self.pushButton_2.setText(_translate("MainWindow", "Connect"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Text message ..."))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Chat"))
        self.pushButton_5.setText(_translate("MainWindow", "Generate connection data"))
        self.lineEdit_4.setPlaceholderText(_translate("MainWindow", "Server address ..."))
        self.lineEdit_5.setPlaceholderText(_translate("MainWindow", "Server port ..."))
